  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="h-screen w-full flex flex-row from-[#140C42] to-[#0A071A] bg-[radial-gradient(ellipse_at_center,var(--tw-gradient-stops))] text-white">
        <div className="flex flex-col gap-y-8 pl-16 justify-center w-[50%]">
          ...
          <p className="text-[#F5F3FFB2] font-inter font-[400] text-[1rem]">
            The all-in-one social platform powered by PAPPS for <br />{" "}
      ...
      <section className="h-full min-h-screen py-14">
        <h1 className="font-inter font-semibold text-[3rem] text-center">
          Everything you need in <span className="text-[#694BF1]"> one</span>{" "}
          app
        </h1>
        <h4 className="text-[#6A7687] text-center font-inter font-normal text-[1rem]">
          From instant messaging to cross-border payments, AfriTalks brings
          together all the tools you need to <br /> connect and transact across
          Africa.
        </h4>
        ...
        <div className="grid grid-cols-2 w-fit mx-auto mt-10 gap-5">
          <Image
            ...
            height={1800}
            alt="instant message"
            className="h-[33.1rem] w-[32.75rem]"
          />
          <Image
            src={Payments}
            width={1800}
      ...
      <section className="h-screen min-h-screen w-fit flex mx-auto justify-center mt-20">
        <div className="w-[45%]">
          <Image
            src={Iphone}
            alt="how it works"
        ...
        <div className="w-[40%] flex flex-col">
          <h1 className="font-inter font-semibold text-[2.75rem]">
      ...
      <section className="relative h-full bg-[#F5F3FF] flex flex-col items-center pt-20 pb-32 space-y-5 px-40">
        <h1 className="text-[#122231] font-inter font-semibold text-[2.75rem]">
          Powered by <span className="text-[#694BF1]"> PAPPS</span>
        </h1>
        <p className="text-[#6A7687] text-center w-[75%] font-inter font-normal text-[1rem]">
        ...
        <div className="absolute top-[26rem] flex flex-col items-center text-center gap-y-4">
      ...
      <section className="h-full w-fit flex mx-auto px-40 py-28 gap-x-5">
        <div className="w-[50%]">
          <h1 className="text-[#122231] font-inter font-semibold text-[2.75rem]">
            High-end level <br />{" "}
        ...
        <div className="w-[50%] flex m-auto">
          <Image
            ...
            width={1900}
            height={1900}
            className="w-[33rem] h-[29rem] "
          />
        </div>
      </section>

      <section className="w-full h-full mt-10 mb-40 pl-4 flex flex-col mx-auto">
        <h1 className="text-[#122231] font-inter font-semibold text-[2.75rem] text-center">
      ...
      <section className="w-full h-full pb-40">
        <h1 className="text-[2.75rem] font-inter font-semibold text-center leading-[3rem]">
          Trusted by <span className="text-[#694BF1]"> communities</span> <br />{" "}
          across Africa
        </h1>
        <p className="text-[#6A7687] font-inter font-normal text-[1rem] text-center">
          Whether you’re chatting with loved ones, sending money across borders,
          or sharing moments <br /> through short videos, AfriTalks keeps you
      ...
      <section
        className="bg-[#0A071A] h-[25.5rem] mx-40 mb-20 rounded-xl flex flex-col items-center justify-center bg-cover"
        style={{ backgroundImage: `url(${Base_Map.src})` }}
      >
        <h1 className="text-[2.5rem] font-semibold font-inter bg-gradient-to-r from-[#FFFFFF] to-[#939299] text-transparent bg-clip-text">
          The future of African communication.
        </h1>
        <p className="text-[#F5F3FF] font-light text-[1rem] font-inter mt-2">
